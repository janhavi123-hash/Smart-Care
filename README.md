...
4️⃣ OCR Medicine Scanner The app includes an OCR (Optical Character Recognition) feature. Users can: Scan medicine strips or prescriptions Automatically detect the medicine name from the image This makes medicine entry faster and easier. 

5️⃣ Emergency Alert Button 🚨 The app also has an Emergency Alert button. When the user presses the button: An alert message is immediately sent to the caregiver This helps during medical emergencies or urgent situations. 💡 Real-World Impact SmartCare can help: Elderly people living alone Patients who take regular medicines Families who want to monitor their loved ones' health The app improves medicine management, safety, and communication between patients and caregivers.

---
Download SmartCare App
You can install the SmartCare mobile application using the APK below:
Download APK: https://expo.dev/accounts/janhavisonawane171/projects/smartcare-medicine-reminder-janhavi/builds/6b9b1c68-65b2-43db-8b1b-9fb767450a73
